export const validateRegisterStep1 = ({ nombre, apellido, correo, contraseña }) => {
    const errors = {}
...
export const validateRegisterPacienteStep2 = ({ fecha_nacimiento, estatura, peso, cedula, telefono }) => {
    const errors = {}
...
export const validateRegisterMedicoStep2 = ({ cedula, fecha_nacimiento, telefono, direccion, id_especialidad }) => {
    const errors = {}
